...
async function oldestPresentationData() {
    ...
    for (let i = 0; i < (json.length); i++) {
        ...
        if (json[0].Imagefilepath === 'null') {
            ...
            loadout += '<figure class="recipefigure"><img src="' + replaceimage + '"><p class="fontsizeforp">' + json[0].Recipename + '</p><p class="fontsizeforp">' + json[0].Recipetime + '</p><p class="fontsizeforp">' + json[0].Coursetype + '</p><p class="fontsizeforp">' + json[0].Mealtype + '</p> <button > Katso resepti</button ></figure >'
        } else {
            loadout += '<figure class="recipefigure"><img src="' + url + '/' + json[0].Imagefilepath + '"><p class="fontsizeforp">' + json[0].Recipename + '</p><p class="fontsizeforp">' + json[0].Recipetime + '</p><p class="fontsizeforp">' + json[0].Coursetype + '</p><p class="fontsizeforp">' + json[0].Mealtype + '</p> <button > Katso resepti</button ></figure >'
        }
