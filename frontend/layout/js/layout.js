...
async function oldestPresentationData() {
    ...
    for (let i = 0; i < (json.length); i++) {
        ...
        if (json[0].Imagefilepath === 'null') {
            ...
            loadout += '<figure class="recipefigure"><img src="' + replaceimage + '"><p class="fontsize2point5vh">' + json[0].Recipename + '</p><p class="fontsize2point5vh">' + json[0].Recipetime + '</p><p class="fontsize2point5vh">' + json[0].Coursetype + '</p><p class="fontsize2point5vh">' + json[0].Mealtype + '</p> <button > Katso resepti</button ></figure >'
        } else {
            loadout += '<figure class="recipefigure"><img src="' + url + '/' + json[0].Imagefilepath + '"><p class="fontsize2point5vh">' + json[0].Recipename + '</p><p class="fontsize2point5vh">' + json[0].Recipetime + '</p><p class="fontsize2point5vh">' + json[0].Coursetype + '</p><p class="fontsize2point5vh">' + json[0].Mealtype + '</p> <button > Katso resepti</button ></figure >'
        }
...
function register() {
    pageGeneration.innerHTML = ` <img id="signupImage" src="media/logos/jakrecipeslogo.svg" alt="jakrecipeslogo"> <H2 class="otsikko">Rekisteröidy</H2> <div class="signup"> <ul class="tiedot"> <li> <p class="fontsize2point5vh">Email</p></li><li><input required type="email" id="emailInputSignUp" placeholder="(Eg. John@gmail.com)"></li><li> <p class="fontsize2point5vh">Password</p></li><li><input pattern="(?=.*[\p{Lu}]).{8,}" required type="password" id="passwordInputSignUp" placeholder="(Atleast 8 letters & 1 capital)"></li></ul> </div><div class="nappi"> <button id="signupNappi">Sign Up</button> </div>`
...
function profile() {
    pageGeneration.innerHTML = ` <H2 class="otsikko">Profiili</H2> <article id="profileArticle"> <section> <H2 id="userPostTitle">User Posts</H2> <div class="userPosts"> <figure>
     <img src="media/logos/jakrecipeslogo.svg"> <p class="fontsize2point5vh">Recipe Name</p> <button>Katso</button> </figure> <figure> <img src="media/logos/jakrecipeslogo.svg"> <p class="fontsize2point5vh">Recipe Name</p> <button>Katso</button> </figure> <figure> <img src="media/logos/jakrecipeslogo.svg"> <p class="fontsize2point5vh">Recipe Name</p> <button>Katso</button></figure> <figure> <img src="media/logos/jakrecipeslogo.svg"> <p class="fontsize2point5vh">Recipe Name</p> <button>Katso</button> </figure> </div> </section>  <div class="userProfile"> <img id="profilepic" src="media/logos/jakrecipeslogo.svg" alt="jakrecipeslogo"> <p class="fontsize2point5vh">Username</p><button id="editProfile">Edit Profile</button> </div><div id="editModal" class="modal"> <div class="modal-content"> <span class="close">&times;</span> <div class="username"> <p class="fontsize2point5vh">Username</p><input> </div><div class="pic"> <p class="fontsize2point5vh">Profile Picture</p><button>Upload Image</button> </div><div class="save"> <button>Save</button> <button id="delete">Delete Profile</button> </div><div id="deleteModal" class="modal"> <div class="modal-content"> <span class="closeDelete">&times;</span> <div> <p class="fontsize2point5vh">Are you sure you want to delete your profile?</p></div><div class="deleteProfile"> <button id="noButton">No</button> <button>Yes</button> </div></div></div></div></div><script>const noButton=document.getElementById("noButton"); const editProfile=document.getElementById("editModal"); const button=document.getElementById("editProfile"); let closeModal=document.getElementsByClassName("close")[0]; let closeDelete=document.getElementsByClassName("closeDelete")[0]; const deleteProfile=document.getElementById("deleteModal"); const deleteButton=document.getElementById("delete"); button.onclick=function (){editProfile.style.display="block";}closeModal.onclick=function (){editProfile.style.display="none";}window.onclick=function (event){if (event.target==editProfile){editProfile.style.display="none";}}deleteButton.onclick=function (){deleteProfile.style.display="block";}closeDelete.onclick=function (){deleteProfile.style.display="none";}noButton.onclick=function (){deleteProfile.style.display="none";}</script> </article> `
}
function LogOut() {
